    ...
    <div className="space-y-5">
      ...
      <div className="glass-panel p-4 sm:p-5 rounded-2xl flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 border border-slate-200 shadow-2xs">
        <div>
          <div className="flex items-center gap-2">
            <h2 className="text-base font-bold text-slate-900 flex items-center gap-2">
              ...
              Governance, Audit Trail &amp; Analytics
            </h2>
          ...
          <p className="text-xs text-slate-500 mt-0.5">
            Tamper-evident access logging in <code className="text-indigo-700 bg-slate-100 px-1 py-0.5 rounded font-mono font-semibold">audit_store.audit_logs</code> &bull; Referential analytics across tokens
          </p>
        </div>
        ...
        <button
          onClick={loadData}
          disabled={loading}
          className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-slate-100 hover:bg-slate-200 border border-slate-300 text-xs font-bold text-slate-700 transition-all disabled:opacity-50 shadow-2xs"
        >
