          ...
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-base font-bold text-slate-900 flex items-center gap-2">
                ...
                Batch Ingestion &amp; De-identification Pipeline
              </h2>
            ...
            <p className="text-xs text-slate-500 mt-0.5">
              Extracts batches from <code className="text-indigo-700 bg-slate-100 px-1 py-0.5 rounded font-mono font-semibold">source_store</code>, executes FPE &amp; HMAC tokenization, and upserts into <code className="text-emerald-700 bg-emerald-50 px-1 py-0.5 rounded font-mono font-semibold">protected_store</code>
            </p>
          </div>

          <form onSubmit={triggerBatch} className="flex items-center gap-2.5">
            <div className="flex items-center gap-1.5">
              ...
              <input
                ...
                className="w-20 bg-white border border-slate-300 rounded-lg px-2.5 py-1.5 text-xs text-slate-900 font-bold focus:outline-none focus:ring-2 focus:ring-indigo-500 font-mono shadow-2xs"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={running}
              className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs shadow-sm transition-all disabled:opacity-50"
            >
              {running ? (
                <>
